...
/**
 * Created by eileenzhang on 16-05-11.
 */
public class WeatherDataParser {
    private static final String TAG = WeatherDataParser.class.getSimpleName();

    public static double getMaxTeperatureForDay(String weatherJsonStr, int dayIndex){
        try {
            ...
            if (weatherArray.length()>=dayIndex){
                JSONObject dayObject = weatherArray.getJSONObject(dayIndex);
